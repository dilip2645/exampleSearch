...
export class PhoneComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.phoneService
        ...
        .subscribe(
          (res: HttpResponse<IPhone[]>) => this.paginatePhones(res.body, res.headers),
  ...
  trackId(index: number, item: IPhone) {
    return item.id;
  }
  ...
  protected paginatePhones(data: IPhone[], headers: HttpHeaders) {
